...
class ControllerModuleDSocialLogin extends Controller {
	...
	public function __construct($registry) {
		...
		$this->load->model('module/dsociallogin');

		$this->mbooth = $this->model_module_dsociallogin->getMboothFile($this->id, $this->sub_versions);
	...
	public function index() {
		...
		$data['stores'] = $this->model_module_dsociallogin->getStores();
		$data['mbooth'] = $this->mbooth;
		$data['config'] = $this->model_module_dsociallogin->getConfigFile($this->id, $this->sub_versions);
		$data['version'] = $this->model_module_dsociallogin->getVersion($data['mbooth']);
		...
		//get config 
		$data['config_files'] = $this->model_module_dsociallogin->getConfigFiles($this->id);

		//customer groups
		$data['customer_groups'] = $this->model_customer_customer_group->getCustomerGroups();

		//debug
		$data['debug'] = $this->model_module_dsociallogin->getFileContents(DIR_LOGS.$data['setting']['debug_file']);
		...
		$this->model_module_dsociallogin->installDatabase();
